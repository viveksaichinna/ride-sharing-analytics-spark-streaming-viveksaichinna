...
def main():
    ...
    spark = SparkSession.builder \
        .appName("RideShare-Task3-WindowedAnalytics") \
        .master("local[*]") \
        .getOrCreate()

    spark.sparkContext.setLogLevel("WARN")
    print("Task 3: Performing windowed time-based analytics")
    ...
    checkpoint_dir = "checkpoints/task3"
    ...
    # Note: For Task 3, we're only grouping by time window, not by driver_id
